      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="mb-12 flex flex-col gap-12 lg:flex-row lg:justify-between">
          ...
          <div>
            ...
            <Link href="/blog" className="mb-2.5 block text-sm text-white/40 transition-colors hover:text-white/80">Blog</Link>
            <Link href="/podcast" className="mb-2.5 block text-sm text-white/40 transition-colors hover:text-white/80">Podcast</Link>
            <Link href="/contact" className="mb-2.5 block text-sm text-white/40 transition-colors hover:text-white/80">Contact Us</Link>
          </div>
